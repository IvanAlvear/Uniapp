...
class _ModalEditWidgetState extends State<ModalEditWidget> {
  ...
  void initState() {
    ...
    _model.provinciaController ??= TextEditingController();
    _model.provinciaFocusNode ??= FocusNode();

    _model.municipioController ??= TextEditingController();
    _model.municipioFocusNode ??= FocusNode();

    _model.carreraController ??= TextEditingController();
    _model.carreraFocusNode ??= FocusNode();

    _model.semestreController ??= TextEditingController();
    _model.semestreFocusNode ??= FocusNode();

    _model.jornadaController ??= TextEditingController();
    _model.jornadaFocusNode ??= FocusNode();
            ...
            child: Column(
              ...
              children: [
                Align(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(20.0, 40.0, 29.0, 20.0),
                    child: Container(
                      width: double.infinity,
