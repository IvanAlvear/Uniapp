                                ...
                                children: [
                                  TextSpan(
                                    text: FFLocalizations.of(context).getText(
                                      '14ndmdsh' /* "Tu Éxito, Nuestra App: Uniend... */,
                                    ),
                                    style: TextStyle(),
                                  )
                                ],
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'x1b5bwry' /* Ingenieria Informatica  */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelLarge
                                        .override(
                            ...
                            Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'pi7lfx3z' /* Director de desarrollo del apl... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'cpn1h1sz' /* FERNEY ANDRES CUASPUD SUAREZ */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyLarge
                                        .override(
                            ...
                            Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'w3iz3tvs' /* Director del desarrollo de la ... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'e7ggj293' /* IVAN DAVID ALVEAR ORTEGA */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyLarge
                                        .override(
                            ...
                            Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'xdw4k0qa' /* Estudiante de octavo semestre,... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'jtsl36d8' /* PEDRO SEBASTIAN HERNANDEZ GRAN... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyLarge
                                        .override(
                            ...
                            Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'bt4mvt2n' /* Estudiante de octavo semestre,... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
